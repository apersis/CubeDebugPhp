...
<section id="homepage" class="homepage">
    <div class="container">
        <div class="section-title">
            ...
            <p>La calculatrice de pourcentage vous permet de calculer facilement le pourcentage de n’importe quel chiffre, une calculatrice utile et simple à utiliser.</p>
        </div>
